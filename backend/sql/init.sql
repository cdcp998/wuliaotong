...
INSERT INTO sys_menu (id, parent_id, name, path, icon, perm_code, visible, sort) VALUES
  ...
  (11, 8, '送货单识别入库', '/ocr/delivery', 'FileSearchOutlined', 'pch:ocr', 0, 30),
  ...
  (21, 18, '领用审计', '/requisitions', 'AuditOutlined', 'req:audit', 0, 30),
  ...
  (33, 26, '备份管理', '/system/backups', 'HddOutlined', 'sys:backup', 0, 60),
