...
module = ModuleDef(
    ...
    audit_labels={"map": "地图"},
    audit_actions={
        ("PUT", "/map/config"): "修改地图配置",
        ("PUT", "/map/sources"): "保存地图源配置",
        ("DELETE", "/map/sources/{source}"): "删除地图源",
        ("POST", "/map/cache/regions"): "新建地图缓存区域",
        ("PUT", "/map/cache/regions/{id}"): "编辑地图缓存区域",
        ("POST", "/map/cache/regions/{id}/start"): "开始区域缓存下载",
        ("POST", "/map/cache/regions/{id}/pause"): "暂停区域缓存下载",
